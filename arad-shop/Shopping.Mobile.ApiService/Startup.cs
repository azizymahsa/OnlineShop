...
using Shopping.Mobile.ApiService.Activator.Resolver;
using Shopping.Mobile.ApiService.BusConfigs;
...
namespace Shopping.Mobile.ApiService
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            IocManager.Instance.IocContainer.Install(new MobileApiServiceInstaller());
